export * as _ from "https://cdn.skypack.dev/lodash@4.17.21";
...
export type { Denops } from "https://deno.land/x/denops_std@v1.0.0-beta.3/mod.ts";
export * as vars from "https://deno.land/x/denops_std@v1.0.0-beta.3/variable/mod.ts";
export * as fn from "https://deno.land/x/denops_std@v1.0.0-beta.3/function/mod.ts";
export { execute } from "https://deno.land/x/denops_std@v1.0.0-beta.3/helper/mod.ts";
